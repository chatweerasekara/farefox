        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5">
          <div className="flex items-center justify-between gap-2">
            {[
              ...
              ), title: 'Finds cheapest', sub: 'Jetstar & Sri-Lankan Airlines only' },
              { icon: (
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#C17B2A" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
<button className="flex items-center gap-1" onClick={() => setActivePage('flights')}
              ...
              <div style={{ position: 'relative', width: 64, height: 64, flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <span style={{
                  position: 'absolute', fontSize: 26, lineHeight: 1, zIndex: 1,
              ...
              <div>
                <div className="leading-none" style={{ marginLeft: '-71px' }}>
                ...
                <div className="text-gray-400 mt-0.025" style={{ fontSize: 10 }}>Your family's flight radar</div>
              </div>
            </button>
